  ...
  return (
    <Card className="overflow-hidden group card-premium bg-white border-premium hover:border-gold shadow-premium text-base">
      ...
      <CardFooter className="p-6 pt-0">
        <Button className="w-full btn-secondary-premium group-hover:bg-premium-dark group-hover:text-white group-hover:border-premium-dark" onClick={() => onViewDetails?.(product)}>
          View Details
        </Button>
      </CardFooter>
    </Card>
