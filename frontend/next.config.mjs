...
const nextConfig = {
  ...
  images: {
    ...
    loader: 'default',
    path: '/_next/image',
    domains: ["firebasestorage.googleapis.com", "mzvuuvtckcimzemivltz.supabase.co"],
    remotePatterns: [
    ...
    return [
      {
        ...
        headers: [
          ...
          { key: "Content-Security-Policy", value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://checkout.razorpay.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https: blob:; connect-src 'self' https://.supabase.co https://.firebase.com https://*.googleapis.com https://checkout.razorpay.com; frame-src 'self' https://checkout.razorpay.com;" },
