...
import { Leaf, Globe, Shield, BadgePercent, Crown, Award, ChevronUp, ArrowLeft, ArrowRight} from 'lucide-react';
    ...
    <>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 overflow-visible pt-6 sm:pt-8">
          ...
          {/* Marquee with arrows */}
          <motion.div
            className="mb-4 sm:mb-6 overflow-visible relative"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div
              ...
              style={{ minHeight: "250px", paddingTop: "5px", paddingBottom: "5px" }}
            >
                    ...
                    <Suspense fallback={<div className="h-80 bg-white" />}>
                      ...
                      <div className="relative w-full">
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (marqueeRef.current) {
                              marqueeRef.current.scrollLeft -= 280; // Scroll left by 280px
                            }
                          }}
                        ...
                        <button
                          ...
                          onClick={() => {
                            if (marqueeRef.current) {
                              marqueeRef.current.scrollLeft += 280; // Scroll right by 280px
                            }
                          }}
                        ...
                        >
                          {safeMap(allFounders, (founder: Founder, index: number) => (
                            <motion.div
                              key={index}
                              className={`founder-card group relative w-72 sm:w-80 mx-4 transition-all duration-700 ease-out cursor-pointer ${
                                index === allFounders.length - 1 ? 'lg:col-start-2' : ''
                              }`}
                              ...
                              <div className="relative h-[220px] sm:h-[240px] md:h-[360px] lg:h-[280px] xl:h-[300px] bg-white rounded-3xl border border-black shadow-md hover:shadow-2xl transition-all duration-700">
                                <div className="relative z-10 p-4 sm:p-5 md:p-6 lg:p-7 xl:p-8 h-full flex flex-col justify-between">
                                  ...
                                  <div className="flex items-center justify-center space-x-2 sm:space-x-3 mt-auto">
                                    ...
                                    {/* Add Twitter & Instagram similarly */}
                                  </div>
                                </div>
                                <div
                                  className={`absolute -top-4 -right-4 w-16 h-16 bg-gradient-to-br ${founder.gradient} rounded-full opacity-10 transition-all duration-700`}
                                ></div>
                                <div
                                  className={`absolute -bottom-4 -left-4 w-12 h-12 bg-gradient-to-br ${founder.gradient} rounded-full opacity-10 transition-all duration-700`}
                                ></div>
                              </div>
                            </motion.div>
                          ))}
